...
// left-aligned problem statement + a laconic "diagnostic scope" motif on the
// right (concentric rings + brand plus + a located-anomaly dot). The root-cause
      ...
      <div className={styles.grid}>
        ...
        <div className={styles.visual} aria-hidden="true">
          <div className={styles.scope}>
            ...
            <PlusMark size={64} className={styles.scopePlus} />
          </div>
        </div>
      </div>
    </div>
